...
#define VER "fv1.0.4"
#define DEV "chase"
#define MAC "cc50e39908ec"

#define URL "https://%s:%s/update?ver=%s&dev=%s&x_ESP32_STA_MAC=%s"
...
void simple_ota_example_task(void *pvParameter)
{
    ...
    sprintf(url, URL, IP, PORT, VER, DEV, MAC);
